...
public class SPRepository {
    ...
    public ArrayList<ViewSanPham> selectLoaiHanh(String tenLH) {
        ...
        String sql = "SELECT MaSP, TenSP, SoLuongTon, TenDL, TenLH, GiaBan FROM SANPHAM JOIN PhanLoaiHang ON SANPHAM.Id_PhanLoai = PhanLoaiHang.Id JOIN DungLuong ON SANPHAM.Id_DLuong = DungLuong.Id WHERE TenLH = ?";
        try {
            Connection connection = DBContext.getConnection();
            PreparedStatement ps = connection.prepareStatement(sql);
   ...
   public ArrayList<ViewSanPham> selectDungLuong(String tenDL) {
        ArrayList<ViewSanPham> list = new ArrayList<>();
        String sql = "SELECT MaSP, TenSP, SoLuongTon, TenDL, TenLH, GiaBan FROM SANPHAM JOIN PhanLoaiHang ON SANPHAM.Id_PhanLoai = PhanLoaiHang.Id JOIN DungLuong ON SANPHAM.Id_DLuong = DungLuong.Id WHERE TenDL = ?";
        try {
            Connection connection = DBContext.getConnection();
            PreparedStatement ps = connection.prepareStatement(sql);
